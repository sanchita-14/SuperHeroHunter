...
`;
    ...
    let url = 'https://superheroapi.com/api.php/2240830056112406/search/'+searchBar.value;
...
apiRequest.onreadystatechange = function(){
    ...
    if(this.readyState == 4 && this.status == 200){
        ...
        if(data.response==="error"){
            displaySearchedHeroesResult.innerHTML = '<h2 class = "loading-and-error-font"> Oops ! There is no super hero with such name, Please try again. </h2> ';
            return;
